...
describe("category policy",()=>{
 it.each(["Sonstiges","Einkäufe","Online-Einkäufe","Shopping","Online-Shopping","Online-Marktplatzkäufe","Lokaler Einzelhandel","Fachhandel-Einkäufe","Onlinehandel","Zahlungsanbieter"])("verbietet %s",name=>expect(isForbiddenCategoryName(name)).toBe(true));
